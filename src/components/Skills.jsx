...
const CONSTELLATIONS = [
  ...
  },
  {
    ...
    stars: [
      ...
      { name: "CQRS & MediatR", x: 56, y: 80, size: 11, level: "Advanced" },
      { name: "FluentValidation", x: 74, y: 72, size: 10, level: "Advanced" },
      { name: "AutoMapper", x: 26, y: 70, size: 10, level: "Proficient" },
      { name: "BCrypt", x: 46, y: 92, size: 9, level: "Proficient" },
    ],
    lines: [
      [0, 1],
      [0, 3],
